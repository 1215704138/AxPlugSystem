...
| 指标 | v3.0 | v4.1 | **v6.0 Release** | 提升 |
|------|------|------|---------|------|
| I→P 单次 | 0.15 ms | 0.07 ms | **0.008 ms** | 18.8x |
| 缓存命中 | 0.0005 ms | 0.0003 ms | **0.0001 ms** | — |
| 吞吐量 | 38 GB/s | 84 GB/s | **754 GB/s** | 20x |
...
**结论**: Release下完整流程比Halcon快93%, 远超50%目标.
